defmodule ColorMatching.Repo.Migrations.CreatePrintedPairClassifications do
  ...
  def change do
    create table(:printed_pair_classifications) do
      ...
      add :reproduction_profile_id, references(:printer_profiles, on_delete: :restrict), null: false
    ...
    create index(:printed_pair_classifications, [:reproduction_profile_id])
    create index(:printed_pair_classifications, [:test_sheet_pair_id])
    create unique_index(
      :printed_pair_classifications,
      [:test_sheet_pair_id, :reproduction_profile_id, :illuminant],
      where: "active = 1",
